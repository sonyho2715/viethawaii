...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // New Teal/Blue theme - Hawaii ocean inspired
        primary: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Keep Vietnam colors for cultural elements
        vietnam: {
          red: '#da251d',
          yellow: '#ffcd00',
        },
      ...
      backgroundImage: {
        ...
        'gradient-hawaii': 'linear-gradient(180deg, #0d9488 0%, #1d4ed8 50%, #7c3aed 100%)',
      },
      animation: {
